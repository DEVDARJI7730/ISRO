    ...
    <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
      ...
      <div className="max-w-md w-full glass-card p-8 md:p-10 relative z-10">
        <div className="text-center mb-8">
          <h2 className="font-display font-black text-3xl text-white mb-2">Register Scientist</h2>
          <p className="text-sm text-slate-400">Join the Satellite Imaging Analytics Platform</p>
        </div>
        ...
        {/* Google Authentication register button */}
        <button
          type="button"
